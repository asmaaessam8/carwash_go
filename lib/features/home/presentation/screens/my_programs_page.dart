              ...
              builder: (context, snapshot) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final title = data['packageTitle'] ?? 'باقة';
                    final description = data['packageDescription'] ?? '';
                    final remaining = data['remainingWashes'] ?? 0;
                    final total = data['totalWashes'] ?? 0;
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _row('عدد الغسلات', '$total'),
                          _row('المتبقي', '$remaining غسلة'),
                          _row('السعر', '$price ريال'),
                          const SizedBox(height: 16),
                          SizedBox(
                            width: double.infinity,
                            height: 48,
                            child: ElevatedButton.icon(
                              onPressed: remaining <= 0 || status != 'active'
                                  ? null
                                  : () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (_) => PackageBookingPage(
